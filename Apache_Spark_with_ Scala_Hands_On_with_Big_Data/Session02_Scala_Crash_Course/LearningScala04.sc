...
val picardsShip = "Picard" -> "Enterprize-D"
...
val shipList = List("Enterprize", "Defiant", "Voyage", "Deep Space Nine")
...
// reduce() to combine together all the itens in a collection using some function
...
// Maps
val shipMap = Map("Kirk" -> "Enterprize", "Picard" -> "Enterprize-D", "Sisko" -> "Deep Space Nine", "Janeway" -> "Voyager")
...
val ThreeAndZero = oneToTwenty.filter((x: Int) => (x % 3) == 0)
